        ...
        ul
          ...
          li
            router-link(:to="{ path: '/scene/lat/2' }")
              img.rounded(src="/static/img/button/scene-lat-2focus.png" onmouseover="this.src='/static/img/button/scene-lat-2focus.png'" onmouseout="this.src='/static/img/button/scene-lat-2.png'")
          li

        ...
        ul
          ...
          li
            router-link(:to="{ path: '/scene/med/5' }")
              img.rounded(src="/static/img/button/scene-med-5focus.png" onmouseover="this.src='/static/img/button/scene-med-5focus.png'" onmouseout="this.src='/static/img/button/scene-med-5.png'")

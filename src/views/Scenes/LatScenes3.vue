        ...
        ul
          ...
          li
            router-link(:to="{ path: '/scene/lat/3' }")
              img.rounded(src="/static/img/button/scene-lat-3focus.png" onmouseover="this.src='/static/img/button/scene-lat-3focus.png'" onmouseout="this.src='/static/img/button/scene-lat-3.png'")

        ...
        ul
          ...
          li
            router-link(:to="{ path: '/scene/med/3' }")
              img.rounded(src="/static/img/button/scene-med-3focus.png" onmouseover="this.src='/static/img/button/scene-med-3focus.png'" onmouseout="this.src='/static/img/button/scene-med-3.png'")
          li

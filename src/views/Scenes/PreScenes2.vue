    ...
    .row
      .col-sm-3.col-md-3.col-lg-3.text-center
        ul
          li
            router-link(:to="{ path: '/scene/pre/1' }")
              img.rounded(src="/static/img/button/scene-pre-1.png" onmouseover="this.src='/static/img/button/scene-pre-1focus.png'" onmouseout="this.src='/static/img/button/scene-pre-1focus.png'")
          li
            router-link(:to="{ path: '/scene/pre/2' }")
              img.rounded(src="/static/img/button/scene-pre-2focus.png" onmouseover="this.src='/static/img/button/scene-pre-2focus.png'" onmouseout="this.src='/static/img/button/scene-pre-2.png'")
